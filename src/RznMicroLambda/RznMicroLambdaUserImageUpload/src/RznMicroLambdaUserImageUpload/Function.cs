...
using RznMicroLambdaUserImageUpload.Message;


// Assembly attribute to enable the Lambda function's JSON input to be converted into a .NET class.
[assembly: LambdaSerializer(typeof(Amazon.Lambda.Serialization.SystemTextJson.DefaultLambdaJsonSerializer))]

namespace RznMicroLambdaUserImageUpload
{
    public class Function
    {
        ...
        private async Task ProcessMessageAsync(SQSEvent.SQSMessage message, ILambdaContext context)
        {
            try
            {
                var userMessage = JsonConvert.DeserializeObject<ImageUploadMessage>(message.Body);
        ...
        private async Task UpdateUserAsync(ImageUploadMessage user)
        {
            var request = new UpdateItemRequest
            {
                ...
                {
                    //User
                    {":avatarUrl", new AttributeValue { S = user.Url }},
                    {":avatarKeyName", new AttributeValue { S = user.ImageKey }},
                },
                UpdateExpression = @"
                    SET avatarUrl     = :avatarUrl, 
                        avatarKeyName = :avatarKeyName
                ",
